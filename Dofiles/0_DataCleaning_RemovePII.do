...
* Remove remaining PII

drop *mob*
drop firstname _firstname 
drop *suffix* bench_emergency_cont_name
drop bench_int_name
drop bench_z1a_firstname_fam bench_b1_firstname_BL bench_tt_name bench_z8_outside_hh_name
drop end_permaddres
drop *barang*
compress
save "$work/facilmig_public",replace
...
* Generate missing variable flags
